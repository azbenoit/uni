...
class GraphicalLife(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.canvas = tk.Canvas(self,
                                width=self.board.x_size * self.scale,
                                height=self.board.y_size * self.scale,
                                bg='white')

        # UNCOMMENT THE FOLLOWING LINE IN EXERCISE 7
    ...
    def save(self):
        f = fdialog.asksaveasfile(mode='w',
                                  defaultextension=".lf",
                                  filetypes = (("Life files", '*.lf'),))
